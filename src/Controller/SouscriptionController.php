...
class SouscriptionController extends AbstractController
{
    ...
    {
        return $this->render('souscription/index.html.twig', ['souscriptions' => $souscriptionRepository->findAll()]);
    }
    ...
    {
        return $this->render('souscription/show.html.twig', ['souscription' => $souscription]);
    }
    ...
    public function edit(Request $request, Souscription $souscription): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('souscription_edit', ['id' => $souscription->getId()]);
        }
